...
Usage:
  python paper2/cfrun_mediumtuned/eval_sweep_best_model.py \
      --models_dir paper2/cfrun_mediumtuned/recent_models_arcade\
      --qrels_path paper2/cfrun_mediumtuned/test_triplets_hard.jsonl \
      --mats_dir qd_matrices_CF18_mediumtuned/ \
