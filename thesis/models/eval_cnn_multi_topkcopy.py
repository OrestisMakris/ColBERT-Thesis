...
if __name__ == "__main__":
    main()
 #python thesis/models/eval_cnn_multi_topkcopy.py   --model_path thesis/models/cnn_classifier_v2.pt   --qrels_path thesis/models/test_pairs.jsonl   --mats_dir padded_matrices_cnn_cf_tune/   --topk 5,10,20,50,100   --qrels_format jsonl^C