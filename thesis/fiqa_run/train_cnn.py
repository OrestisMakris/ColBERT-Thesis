...
# --- Configuration ---
MATRICES_DIR          = "/home/st1084516/ColBERT-Thesis/qd_matrices_fiqa_untuned"  # Directory containing the precomputed matrices
TRAIN_DATA_FILE       = "train_triplets_fiqa.jsonl"
VALIDATION_DATA_FILE  = "validation_triplets_fiqa.jsonl"
MODEL_SAVE_PATH       = "cnn_classifier_best_triliza_fiqa.pt" # Path for the single best model
MODEL_SAVE_DIR        = "recent_models_triliza_fiqa"          # Directory for the last 15 models
