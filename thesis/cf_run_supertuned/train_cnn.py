...
# --- Configuration ---
MATRICES_DIR          = "/home/st1084516/ColBERT-Thesis/qd_matrices_cf_tune"
TRAIN_DATA_FILE       = "train_triplets_cf_sm.jsonl"
VALIDATION_DATA_FILE  = "validation_triplets_cf_sm.jsonl"
MODEL_SAVE_PATH       = "cnn_classifier_best_triliza_sm.pt" # Path for the single best model
MODEL_SAVE_DIR        = "recent_models_triliza_sm"          # Directory for the last 15 models
